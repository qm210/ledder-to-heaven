...
D.h.
- Base Square: Index 0..63 starting from "corner @ back, to the right", clockwise
- Logo Segment: Index 64..169 in shown order
- Back LED (Only White): 170
- Floor LED (Only White): 171
